  ...
  return <EditorialDialog title={work.title} className="ed-gallery-dialog" onClose={onClose}>
    <div className="ed-gallery-viewer">
      ...
      <aside className="ed-gallery-details">
        ...
        <h3>{work.artist}</h3>
        {work.artistUrl && <a className="ed-text-link" href={work.artistUrl} target="_blank" rel="noopener noreferrer">artist profile <ArrowUpRight size={16} /></a>}
        ...
        {work.variants.length > 1 && <div className="ed-gallery-variants" role="group" aria-label="Artwork versions">
          <span className="ed-label">versions</span>
...
export default function CommissionGallery() {
  ...
  return <div className="ed-page ed-gallery">
    <header className="ed-page-heading ed-gallery-heading"><div><h1>gallery</h1>
      <p>art i’ve commissioned</p></div>
      <div className="ed-gallery-count"><strong>{String(galleryWorks.length).padStart(2, "0")}</strong><span className="ed-label">commissions</span></div>
    </header>
