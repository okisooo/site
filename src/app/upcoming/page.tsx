    ...
    <div className="min-h-screen bg-black text-white p-3 sm:p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8 sm:mb-10 bg-gray-900 rounded-lg p-4 sm:p-6">
          <h2 className="text-xl sm:text-2xl font-bold mb-3">Pre-save Next Release</h2>
          <div className="flex flex-col md:flex-row items-center gap-4 sm:gap-6">
            ...
            <div className="w-full md:w-2/3 mt-4 md:mt-0">
              <h3 className="text-lg sm:text-xl font-semibold mb-2">FANTASIA</h3>
              <p className="text-gray-300 mb-4 text-sm sm:text-base">Available March 10th</p>
              <a 
                href="https://open.spotify.com/prerelease/4r7bY4BqBNRkZZen7ZHArD?si=2267ae6eda844a56" 
                target="_blank" 
                rel="noopener noreferrer"
                className="bg-green-600 hover:bg-green-700 text-white px-4 sm:px-6 py-3 rounded-full inline-flex items-center gap-2 transition-colors min-h-[44px] touch-action-manipulation"
              >
        ...
        <div className="mb-8">
          <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4">Release Schedule</h2>
          <p className="text-gray-300 text-sm sm:text-base">
            Next release expected: <span className="font-semibold">March 10 2025</span>
          </p>
        ...
        <Link 
          href="/" 
          className="text-gray-300 hover:text-white transition-colors inline-block py-3 text-base sm:text-base min-h-[44px]"
        >
          ← Back to home
        </Link>
      </div>
