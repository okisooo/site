      ...
      <div className="mb-8 sm:mb-10 bg-gray-900 rounded-lg p-4 sm:p-6">
        ...
        <div className="flex flex-col md:flex-row items-center gap-4 sm:gap-6">
          ...
          <div className="w-full md:w-2/3 mt-4 md:mt-0">
            ...
            <p className="text-gray-300 mb-4 text-sm sm:text-base [text-shadow:rgb(0,0,0)_0_0_3px]">Available April 7th</p>
            <a 
              href="https://open.spotify.com/prerelease/3TZZT1ctMApXcEahmMYIRE?si=f0c5c563877b4b46" 
              target="_blank" 
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-300 text-sm sm:text-base [text-shadow:rgb(0,0,0)_0_0_3px]">
              Next release expected: <span className="font-semibold [text-shadow:rgb(0,0,0)_0_0_3px]">April 7 2025</span>
            </p>
