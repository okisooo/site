  ...
  return (
    <div className="min-h-screen bg-black text-white p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-10 bg-gray-900 rounded-lg p-6">
          <h2 className="text-2xl font-bold mb-3">Pre-save Next Release</h2>
          <div className="flex flex-col md:flex-row items-center gap-6">
            ...
            <div className="w-full md:w-2/3">
              <h3 className="text-xl font-semibold mb-2">FANTASIA</h3>
              <p className="text-gray-300 mb-4">Available March 10th</p>
              <a 
            href="https://open.spotify.com/prerelease/4r7bY4BqBNRkZZen7ZHArD?si=2267ae6eda844a56" 
            target="_blank" 
            rel="noopener noreferrer"
            className="bg-green-600 hover:bg-green-700 text-white px-6 py-2 rounded-full inline-flex items-center gap-2 transition-colors"
              >
