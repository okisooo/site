          ...
          <div className="flex flex-col md:flex-row gap-3 md:gap-4">
            ...
            <div className="w-full md:w-2/3 flex flex-col justify-center">
              ...
              <div className="mt-2 flex flex-wrap gap-2">
                ...
                <a 
                  href="https://music.apple.com/album/fantasia-etude/2lmc5y1ZnzgSyKzyZOux6q" 
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <a 
                  href="https://okiso.bandcamp.com/" 
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-1.5 px-3 py-1.5 bg-[#1DA0C3]/80 hover:bg-[#1DA0C3] rounded-full text-white text-sm font-medium transition-colors"
                >
                  <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M12 0C5.4 0 0 5.4 0 12s5.4 12 12 12 12-5.4 12-12S18.6 0 12 0ZM9.4 15.6 7 6h9.6l2.4 9.6H9.4Z" />
                  </svg>
                  Bandcamp
                </a>
              </div>
