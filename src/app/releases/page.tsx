    ...
    <div className="min-h-screen w-full relative overflow-hidden bg-black text-white p-3 sm:p-6">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <p className="mb-6 sm:mb-8 text-gray-300 text-sm sm:text-base [text-shadow:rgb(0,0,0)_0_0_4px]">
          Explore all of OKISO's music releases, including the latest singles, albums, and collaborations.
          Listen directly on this page or visit Spotify for the full experience.
        </p>
        
        {/* Spotify Artist Embed - Responsive height */}
        <div className="mb-8 sm:mb-10 bg-gray-900/40 backdrop-blur-sm rounded-lg p-4 sm:p-6">
        ...
        <div className="mb-8 bg-gray-900/40 backdrop-blur-sm rounded-lg p-4 sm:p-6">
          <h2 className="text-xl sm:text-2xl font-bold mb-3 [text-shadow:rgb(0,0,0)_1px_0_5px] [-webkit-text-stroke:0.25px_rgba(0,0,0,0.2)]">
            Featured Release
          </h2>
        ...
        <div className="flex items-center gap-4">
          ...
          <Link
            href="/upcoming"
            className="text-gray-300 hover:text-white transition-colors inline-block py-3 text-base min-h-[44px] [text-shadow:rgb(0,0,0)_0_0_3px] ml-auto"
          >
